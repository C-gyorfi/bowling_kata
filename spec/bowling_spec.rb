...
#this could be the next logical step but its green...
 # context 'when player throws multiple spares through the game' do
 #   xit 'scores the sum of each frame plus double of the first throw in next frame for each spare' do
 #     game.throw(5, 5)
 #     game.throw(3, 3)
 #     game.throw(5, 5)
 #     game.throw(3, 3)
